                    ...
                    <div className="flex-1 flex justify-center items-center relative">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                <div className="bg-white rounded-[40px] p-2 shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white">
                                    <div
                                        className="rounded-[36px] p-12 flex flex-col items-center text-center h-full transition-all duration-1000"
