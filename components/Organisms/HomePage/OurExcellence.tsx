...
const EXCELLENCE_DATA = [
    {
        ...
        description: "With 3 million+ person-hours of effort, backed by 30+ active projects at any time.",
    },
    {
        image: IMAGE_URLS.DIGITAL_TECHNOLOGY,
        count: "20+",
        title: "DIGITAL TECHNOLOGY",
        description: "And a dedicated CoE for Mobility, Industry 4.0, and Cloud solutions.",
    },
    {
        image: IMAGE_URLS.GROWING_WORK_FORCE,
        count: "200+",
        title: "GROWING WORK<br/> FORCE",
        description: "A balanced team of SMEs, Solution Architects, Consultants, and Technology Evangelists.",
    },
    {
...
const OurExcellence = () => {
    return (
        <section className='OurExcellence sec_padding bg-[#F8FAFC] overflow-hidden'>
